...
class MobileNetDetector():
    ...
    def __init__(self,
                 CONFIDENCE = 0.7,
                 args_prototxt = "/home/borg/colcon_ws/src/robcomp_util/robcomp_util/robcomp_util/config/MobileNetSSD_deploy.prototxt.txt",
                 args_model = "/home/borg/colcon_ws/src/robcomp_util/robcomp_util/robcomp_util/config/MobileNetSSD_deploy.caffemodel"
                 ):
